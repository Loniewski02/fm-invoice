...
const Navigation = async () => {
  ...
  return (
    <nav className="sticky left-0 top-0 z-[100] flex justify-between bg-[#373B53] pr-6 dark:bg-VeryDarkBlue03 lg:h-[100dvh] lg:flex-col lg:rounded-r-[20px] lg:pb-6 lg:pr-0">
