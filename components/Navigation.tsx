...
const Navigation = () => {
  return (
    <nav className="left-0 top-0 flex justify-between bg-[#373B53] pr-6 sticky lg:h-[100dvh] lg:flex-col lg:rounded-r-[20px] lg:pb-6 lg:pr-0">
      ...
      <div className="flex items-center gap-6 lg:flex-col">
        ...
        <button className="h-8 w-8 overflow-hidden rounded-full lg:h-10 lg:w-10">
